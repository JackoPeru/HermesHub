...
HERMES_GATEWAY_MAX_REQUEST_MB="${HERMES_GATEWAY_MAX_REQUEST_MB:-256}"
...
HERMES_JARVIS_SUMMARY_EVERY_EVENTS="${HERMES_JARVIS_SUMMARY_EVERY_EVENTS:-6}"
HERMES_JARVIS_SUMMARY_MAX_TOKENS="${HERMES_JARVIS_SUMMARY_MAX_TOKENS:-256}"
HERMES_JARVIS_SUMMARY_TIMEOUT_SECONDS="${HERMES_JARVIS_SUMMARY_TIMEOUT_SECONDS:-15}"
...
HERMES_JARVIS_MAX_CONCURRENT_FAST="${HERMES_JARVIS_MAX_CONCURRENT_FAST:-2}"
HERMES_JARVIS_MAX_CONCURRENT_REASONING="${HERMES_JARVIS_MAX_CONCURRENT_REASONING:-1}"
HERMES_JARVIS_SIMPLE_MIN_CONFIDENCE="${HERMES_JARVIS_SIMPLE_MIN_CONFIDENCE:-0.95}"
...
export HERMES_JARVIS_MAX_PERCEPTIONS HERMES_JARVIS_SUMMARY_EVERY_EVENTS HERMES_JARVIS_SUMMARY_MAX_TOKENS
export HERMES_JARVIS_SUMMARY_TIMEOUT_SECONDS HERMES_JARVIS_CONVERSATION_WINDOW_SECONDS
...
export HERMES_JARVIS_SIMPLE_MIN_CONFIDENCE HERMES_JARVIS_ASSISTIVE_THRESHOLD HERMES_JARVIS_PROACTIVE_THRESHOLD
...
managed_keys = [
    ...
    "HERMES_JARVIS_MAX_PERCEPTIONS", "HERMES_JARVIS_SUMMARY_EVERY_EVENTS", "HERMES_JARVIS_SUMMARY_MAX_TOKENS",
    "HERMES_JARVIS_SUMMARY_TIMEOUT_SECONDS", "HERMES_JARVIS_CONVERSATION_WINDOW_SECONDS",
    ...
    "HERMES_JARVIS_SIMPLE_MIN_CONFIDENCE", "HERMES_JARVIS_ASSISTIVE_THRESHOLD", "HERMES_JARVIS_PROACTIVE_THRESHOLD",
