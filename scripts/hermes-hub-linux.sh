...
HERMES_JARVIS_FAST_BASE_URL="${HERMES_JARVIS_FAST_BASE_URL:-}"
HERMES_JARVIS_FAST_API_KEY="${HERMES_JARVIS_FAST_API_KEY:-}"
HERMES_JARVIS_FAST_MODEL="${HERMES_JARVIS_FAST_MODEL:-}"
HERMES_JARVIS_REASONING_BASE_URL="${HERMES_JARVIS_REASONING_BASE_URL:-}"
HERMES_JARVIS_REASONING_API_KEY="${HERMES_JARVIS_REASONING_API_KEY:-}"
HERMES_JARVIS_REASONING_MODEL="${HERMES_JARVIS_REASONING_MODEL:-Qwen3.5-35B-A3B}"
HERMES_JARVIS_MAX_FRAME_BYTES="${HERMES_JARVIS_MAX_FRAME_BYTES:-1000000}"
HERMES_JARVIS_FRAME_TTL_SECONDS="${HERMES_JARVIS_FRAME_TTL_SECONDS:-20}"
HERMES_JARVIS_SESSION_TTL_SECONDS="${HERMES_JARVIS_SESSION_TTL_SECONDS:-3600}"
HERMES_JARVIS_MAX_CONTEXT_EVENTS="${HERMES_JARVIS_MAX_CONTEXT_EVENTS:-64}"
HERMES_JARVIS_MAX_PERCEPTIONS="${HERMES_JARVIS_MAX_PERCEPTIONS:-128}"
HERMES_JARVIS_CONVERSATION_WINDOW_SECONDS="${HERMES_JARVIS_CONVERSATION_WINDOW_SECONDS:-120}"
HERMES_JARVIS_SEMANTIC_DEDUPE_THRESHOLD="${HERMES_JARVIS_SEMANTIC_DEDUPE_THRESHOLD:-0.82}"
HERMES_JARVIS_SEMANTIC_DEDUPE_SECONDS="${HERMES_JARVIS_SEMANTIC_DEDUPE_SECONDS:-600}"
HERMES_JARVIS_FEEDBACK_STEP="${HERMES_JARVIS_FEEDBACK_STEP:-0.04}"
HERMES_JARVIS_FAST_TIMEOUT_SECONDS="${HERMES_JARVIS_FAST_TIMEOUT_SECONDS:-12}"
HERMES_JARVIS_REASONING_TIMEOUT_SECONDS="${HERMES_JARVIS_REASONING_TIMEOUT_SECONDS:-60}"
HERMES_JARVIS_FAST_MAX_TOKENS="${HERMES_JARVIS_FAST_MAX_TOKENS:-256}"
HERMES_JARVIS_REASONING_MAX_TOKENS="${HERMES_JARVIS_REASONING_MAX_TOKENS:-96}"
HERMES_JARVIS_MAX_CONCURRENT_FAST="${HERMES_JARVIS_MAX_CONCURRENT_FAST:-1}"
HERMES_JARVIS_MAX_CONCURRENT_REASONING="${HERMES_JARVIS_MAX_CONCURRENT_REASONING:-1}"
HERMES_JARVIS_OBSERVER_LATENCY_MULTIPLIER="${HERMES_JARVIS_OBSERVER_LATENCY_MULTIPLIER:-0.25}"
HERMES_JARVIS_OBSERVER_MIN_GAP_SECONDS="${HERMES_JARVIS_OBSERVER_MIN_GAP_SECONDS:-0.75}"
HERMES_JARVIS_OBSERVER_MAX_GAP_SECONDS="${HERMES_JARVIS_OBSERVER_MAX_GAP_SECONDS:-8}"
HERMES_JARVIS_ASSISTIVE_THRESHOLD="${HERMES_JARVIS_ASSISTIVE_THRESHOLD:-0.48}"
HERMES_JARVIS_PROACTIVE_THRESHOLD="${HERMES_JARVIS_PROACTIVE_THRESHOLD:-0.48}"
HERMES_KOKORO_PRELOAD="${HERMES_KOKORO_PRELOAD:-1}"
HERMES_KOKORO_PRELOAD_REQUIRED="${HERMES_KOKORO_PRELOAD_REQUIRED:-1}"
HERMES_KOKORO_PRELOAD_TIMEOUT_SECONDS="${HERMES_KOKORO_PRELOAD_TIMEOUT_SECONDS:-180}"
...
HERMES_KOKORO_STREAM_CHUNK_CHARS="${HERMES_KOKORO_STREAM_CHUNK_CHARS:-220}"
...
HERMES_WHISPER_PRELOAD="${HERMES_WHISPER_PRELOAD:-1}"
HERMES_WHISPER_PRELOAD_REQUIRED="${HERMES_WHISPER_PRELOAD_REQUIRED:-1}"
HERMES_WHISPER_PRELOAD_TIMEOUT_SECONDS="${HERMES_WHISPER_PRELOAD_TIMEOUT_SECONDS:-300}"
HERMES_WHISPER_MODEL="${HERMES_WHISPER_MODEL:-large-v3-turbo}"
HERMES_WHISPER_DEVICE="${HERMES_WHISPER_DEVICE:-cuda}"
HERMES_WHISPER_COMPUTE_TYPE="${HERMES_WHISPER_COMPUTE_TYPE:-int8}"
...
for value in "$HERMES_WAIT_TAILSCALE_ATTEMPTS" "$HERMES_WAIT_TAILSCALE_SLEEP_SECONDS" "$HERMES_WAIT_LLAMA_ATTEMPTS" "$HERMES_WAIT_LLAMA_SLEEP_SECONDS" "$HERMES_KOKORO_PRELOAD_TIMEOUT_SECONDS" "$HERMES_WHISPER_PRELOAD_TIMEOUT_SECONDS"; do
  if ! [[ "$value" =~ ^[1-9][0-9]*$ ]]; then
    echo "ERROR: readiness attempts, waits, and timeouts must be positive integers" >&2
    exit 2
  fi
done
if ! [[ "$HERMES_KOKORO_CUDA_DEVICE" =~ ^[0-9]+$ ]] || ! [[ "$HERMES_WHISPER_DEVICE_INDEX" =~ ^[0-9]+$ ]]; then
  echo "ERROR: CUDA device indexes must be non-negative integers" >&2
  exit 2
fi
...
export HERMES_JARVIS_MAX_FRAME_BYTES HERMES_JARVIS_FRAME_TTL_SECONDS HERMES_JARVIS_SESSION_TTL_SECONDS
export HERMES_JARVIS_MAX_CONTEXT_EVENTS HERMES_JARVIS_FAST_TIMEOUT_SECONDS HERMES_JARVIS_REASONING_TIMEOUT_SECONDS
export HERMES_JARVIS_MAX_PERCEPTIONS HERMES_JARVIS_CONVERSATION_WINDOW_SECONDS
export HERMES_JARVIS_SEMANTIC_DEDUPE_THRESHOLD HERMES_JARVIS_SEMANTIC_DEDUPE_SECONDS HERMES_JARVIS_FEEDBACK_STEP
export HERMES_JARVIS_FAST_MAX_TOKENS HERMES_JARVIS_REASONING_MAX_TOKENS
export HERMES_JARVIS_MAX_CONCURRENT_FAST HERMES_JARVIS_MAX_CONCURRENT_REASONING
export HERMES_JARVIS_OBSERVER_LATENCY_MULTIPLIER HERMES_JARVIS_OBSERVER_MIN_GAP_SECONDS HERMES_JARVIS_OBSERVER_MAX_GAP_SECONDS
export HERMES_JARVIS_ASSISTIVE_THRESHOLD HERMES_JARVIS_PROACTIVE_THRESHOLD
export HERMES_KOKORO_PRELOAD HERMES_KOKORO_PRELOAD_REQUIRED HERMES_KOKORO_PRELOAD_TIMEOUT_SECONDS
export HERMES_KOKORO_REQUIRE_GPU
export HERMES_KOKORO_ONNX_PROVIDER
export HERMES_KOKORO_CUDA_DEVICE
export HERMES_KOKORO_STREAM_CHUNK_CHARS
export HERMES_KOKORO_GPU_MODEL_PATH
export HERMES_KOKORO_CPU_MODEL_PATH
export HERMES_KOKORO_VOICES_PATH
export HERMES_WHISPER_PRELOAD HERMES_WHISPER_PRELOAD_REQUIRED HERMES_WHISPER_PRELOAD_TIMEOUT_SECONDS
export HERMES_WHISPER_MODEL HERMES_WHISPER_DEVICE HERMES_WHISPER_COMPUTE_TYPE HERMES_WHISPER_DEVICE_INDEX
...
managed_keys = [
    ...
    "HERMES_JARVIS_REASONING_BASE_URL", "HERMES_JARVIS_REASONING_API_KEY", "HERMES_JARVIS_REASONING_MODEL",
    "HERMES_JARVIS_MAX_FRAME_BYTES", "HERMES_JARVIS_FRAME_TTL_SECONDS", "HERMES_JARVIS_SESSION_TTL_SECONDS",
    "HERMES_JARVIS_MAX_CONTEXT_EVENTS", "HERMES_JARVIS_FAST_TIMEOUT_SECONDS", "HERMES_JARVIS_REASONING_TIMEOUT_SECONDS",
    "HERMES_JARVIS_MAX_PERCEPTIONS", "HERMES_JARVIS_CONVERSATION_WINDOW_SECONDS",
    "HERMES_JARVIS_SEMANTIC_DEDUPE_THRESHOLD", "HERMES_JARVIS_SEMANTIC_DEDUPE_SECONDS", "HERMES_JARVIS_FEEDBACK_STEP",
    "HERMES_JARVIS_FAST_MAX_TOKENS", "HERMES_JARVIS_REASONING_MAX_TOKENS",
    "HERMES_JARVIS_MAX_CONCURRENT_FAST", "HERMES_JARVIS_MAX_CONCURRENT_REASONING",
    "HERMES_JARVIS_OBSERVER_LATENCY_MULTIPLIER", "HERMES_JARVIS_OBSERVER_MIN_GAP_SECONDS", "HERMES_JARVIS_OBSERVER_MAX_GAP_SECONDS",
    "HERMES_JARVIS_ASSISTIVE_THRESHOLD", "HERMES_JARVIS_PROACTIVE_THRESHOLD",
    "HERMES_KOKORO_ONNX_PROVIDER", "HERMES_KOKORO_CUDA_DEVICE", "HERMES_KOKORO_STREAM_CHUNK_CHARS",
    "HERMES_KOKORO_GPU_MODEL_PATH", "HERMES_KOKORO_CPU_MODEL_PATH",
    "HERMES_KOKORO_VOICES_PATH", "HERMES_WHISPER_PRELOAD", "HERMES_WHISPER_PRELOAD_REQUIRED",
    "HERMES_WHISPER_PRELOAD_TIMEOUT_SECONDS", "HERMES_WHISPER_MODEL", "HERMES_WHISPER_DEVICE",
    "HERMES_WHISPER_COMPUTE_TYPE", "HERMES_WHISPER_DEVICE_INDEX", "HERMES_WAIT_ON_START",
