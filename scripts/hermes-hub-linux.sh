...
HERMES_MEDIA_ROOTS="${HERMES_MEDIA_ROOTS:-$HERMES_TERMINAL_CWD:$HERMES_HOME/cache:$HERMES_HOME/media:$HERMES_VIDEO_LIBRARY_PATH:$HERMES_NEWS_LIBRARY_PATH}"
...
mkdir -p "$HERMES_HOME" "$HERMES_VIDEO_LIBRARY_PATH" "$HERMES_NEWS_LIBRARY_PATH"
